    ...
    <section class="atelier-console" data-atelier-console>
        ...
        <div class="atelier-log" aria-label="Atölye günlüğü">
            ...
            <button class="atelier-log-entry <?= $index === $activeIndex ? 'is-active' : '' ?>" type="button"
                id="update-<?= e($update['_id'] ?? '') ?>"
                data-atelier-entry
                data-update-id="<?= e($update['_id'] ?? '') ?>"
                data-media="<?= e($media) ?>"
                ...
                data-instagram-url="<?= e($update['instagram_url'] ?? '') ?>"
                data-youtube-url="<?= e($update['youtube_url'] ?? '') ?>"
                data-github-url="<?= e($update['github_url'] ?? '') ?>">
