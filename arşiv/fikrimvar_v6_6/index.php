...
<header class="site-header" data-header>
    <div class="shell header-inner">
        ...
        <nav class="main-nav" id="main-nav" aria-label="Ana menü" data-nav>
            ...
            <button type="button" data-atelier-widget-open>Atölye</button>
...
<main id="main">
    <section class="hero" data-parallax-root>
        <div class="hero-atmosphere" aria-hidden="true">
            ...
            <div class="hero-core hero-core--base" data-parallax data-depth="0.12" aria-hidden="true">
                <img class="hero-core-base" src="assets/img/hero/hero-core.png" alt="">
            </div>
            <div class="hero-shade"></div>
            <div class="hero-core hero-core--organic" data-parallax data-depth="0.12" data-organic-hero aria-hidden="true">
        ...
        <div class="shell hero-inner">
            ...
            <div class="hero-index" aria-label="Sitenin içerik yapısı" data-reveal>
                ...
                <button type="button" data-atelier-widget-open><strong><?= str_pad((string) max(1, $atelierCount), 2, '0', STR_PAD_LEFT) ?></strong><span>Canlı atölye</span></button>
...
<?php render_atelier_widget($atelier, $latestAtelier, is_array($atelierWidgetConfig) ? $atelierWidgetConfig : []); ?>
