...
<header class="inner-header">
    <div class="shell inner-header-row">
        ...
        <nav aria-label="Hikâyeler sayfası menüsü"><a href="index.php#manifesto">Manifesto</a><button type="button" data-atelier-widget-open>Atölye</button><a href="index.php">Ana sayfa</a></nav>
    </div>
</header>
