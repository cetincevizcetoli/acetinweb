...
} elseif (!empty($project['story_ready'])) {
    header('Location: ' . story_url($project), true, 302);
    exit;
}
...
<main class="project-main">
    <div class="container">
        ...
        <nav class="story-neighbours" aria-label="Diğer hikâyeler">
            <?php if ($previous): ?><a href="<?= e(story_url($previous)) ?>"><small>ÖNCEKİ KAYIT</small><strong>← <?= e($previous['title'] ?? '') ?></strong></a><?php else: ?><span></span><?php endif; ?>
            <?php if ($next): ?><a class="next" href="<?= e(story_url($next)) ?>"><small>SONRAKİ KAYIT</small><strong><?= e($next['title'] ?? '') ?> →</strong></a><?php endif; ?>
        </nav>
        <?php endif; ?>
    </div>
</main>
