...
if(is_post()){
  ...
  try{
    ...
    $uploaded=save_uploaded_files((int)$project['id'],(string)$project['slug']);$existing=array_map('intval',$_POST['existing_media_ids'] ?? []);attach_update_media($id,array_merge($uploaded,$existing));
