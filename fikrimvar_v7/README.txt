...
storage/      SQLite veritabanı, yedekler ve dışa aktarımlar
...
1. Paketi şu klasöre çıkarın:
   ...
   C:\xampp\htdocs\acetin_fv\fikrimvar_v7
...
5. Önce sistem kontrolünü açın:
   ...
   http://localhost/acetin_fv/fikrimvar_v7/public/system-check.php

6. Site:

   http://localhost/acetin_fv/fikrimvar_v7/public/

7. Yönetim paneli:

   http://localhost/acetin_fv/fikrimvar_v7/admin-local/
...
Yedek
-----
Yönetim panelindeki Yedek ekranı SQLite veritabanının güvenli bir kopyasını
storage/backups/ klasörüne oluşturur.
